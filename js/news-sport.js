...
async function feachNews() {
    ...
    let rezultInDays = (Date.parse(dateForCheckDate) - Date.parse(news[0].publicDate)) / 1000 / 60 / 60 / 24;
    switch (true) {
        case rezultInDays === 0:
    ...
    addNews += `<div class="card-news">
                        <div class="text-for-news">
                            <div class="part-one">
                                <img class="img-for-news" src="img/${news[0].image}" alt="${news[0].altForImg}">
                                <div class="headline">${news[0].headline}
                                    <div class="heading">${news[0].heading}</div>
                                </div>
                            </div>
                            <div id="fb-root"></div>
                            <p class="part-start">${news[0].textForNews}</p>
                            <div class="published" pub="${news[0].publicDate}"> Опубліковано ${addTextAboutAgo}</div>
                        </div>
                    </div>
