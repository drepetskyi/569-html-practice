...
async function feachNews() {
    ...
    let rezultInDays = (Date.parse(dateForCheckDate) - Date.parse(news[2].publicDate)) / 1000 / 60 / 60 / 24;
    switch (true) {
        case rezultInDays === 0:
    ...
    addNews += `<div class="card-news">
                        <div class="text-for-news">
                            <div class="part-one">
                                <img class="img-for-news" src="img/${news[2].image}" alt="${news[2].altForImg}">
                                <div class="headline">${news[2].headline}
                                    <div class="heading">${news[2].heading}</div>
                                </div>
                            </div>
                            <div id="fb-root"></div>
                            <p class="part-start">${news[2].textForNews}</p>
                            <div class="published" pub="${news[2].publicDate}"> Опубліковано ${addTextAboutAgo}</div>
                        </div>
                    </div>
